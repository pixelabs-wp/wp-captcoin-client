      ...
      <form method="post" action="options.php">
        ...
        ?>
          ...
          public function setup_sections()
          {
            ...
            add_settings_section('cognito_machine_auth_settings', 'Cognito Machine Auth Settings', false, 'cognito_login_fields');
            ...
            add_settings_section('new_proposal_settings', 'Website Url Settings', false, 'cognito_login_fields');
          }
          ...
          public function setup_fields()
          {
            $fields = array(
              ...
              // Cognito Machine Auth Settings
              array(
                'uid' => 'machine_app_auth_url',
                'label' => 'Machine Web Authentication Base',
                'section' => 'cognito_machine_auth_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'https://tcc-test.auth.eu-central-1.amazoncognito.com/oauth2/token',
                'helper' => '',
                'supplemental' => 'Base URL of the Cognito authentication endpoint',
                'default' => ''
              ),
              array(
                'uid' => 'machine_app_client_id',
                'label' => 'Machine App Client ID',
                'section' => 'cognito_machine_auth_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'yourAppMachineClientId',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
              array(
                'uid' => 'machine_app_client_secret',
                'label' => 'Machine App Client Secret',
                'section' => 'cognito_machine_auth_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'yourAppMachineClientSecret',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
               array(
                'uid' => 'machine_app_grant_type',
                'label' => 'Machine App Grant Type',
                'section' => 'cognito_machine_auth_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'yourMachineGrantType',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
              array(
                'uid' => 'machine_app_scope',
                'label' => 'Machine App scope',
                'section' => 'cognito_machine_auth_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'yourAppMachineScope',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
              ...
              array(
                'uid' => 'baseurl_for_proposals',
                'label' => 'Proposal By Id Base Url',
                'section' => 'new_proposal_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'https://test.captainscoin.vote/captcoin/',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
              array(
                'uid' => 'baseurl_for_Apis',
                'label' => 'Apis Base Url',
                'section' => 'new_proposal_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'https://apitest.captainscoin.vote/api/',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              ),
              array(
                'uid' => 'baseurl_for_topics_page',
                'label' => 'Topics Base Url',
                'section' => 'new_proposal_settings',
                'type' => 'text',
                'options' => false,
                'placeholder' => 'https://test.captainscoin.vote/topics/',
                'helper' => '',
                'supplemental' => '',
                'default' => ''
              )
