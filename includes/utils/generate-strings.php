...
$actual_link = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    ...
    return $app_auth_url . '/login?client_id=' . $app_client_id . '&response_type=code&scope=openid+https://api.byeshares.com/wordpress' . $oauth_scopes . '&redirect_uri=' . $redirect_url.'&state='.$actual_link;
  }
   ...
   */
  public static function a_tag($atts,$urlParams="")
  {
